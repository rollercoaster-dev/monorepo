...
export default [
  ...
  {
    files: [
      "apps/openbadges-modular-server/**/*.ts",
      "apps/openbadges-system/src/server/**/*.ts",
    ],
    languageOptions: {
      globals: {
        process: "readonly",
          ...
          paths: [
            {
              ...
              message:
                "Foundation package: no workspace imports. See docs/architecture/overview.md",
            },
            {
          ...
          paths: [
            {
              name: "openbadges-ui",
              message:
                "Core package: must not import UI layer. See docs/architecture/overview.md",
            },
            {
              name: "@rollercoaster-dev/design-tokens",
              message:
                "Core package: must not import design-tokens. See docs/architecture/overview.md",
            },
          ],
        },
      ],
  ...
  {
    files: [
      "packages/openbadges-ui/**/*.ts",
      "packages/openbadges-ui/**/*.vue",
    ],
    rules: {
      "no-restricted-imports": [
        "error",
          ...
          paths: [
            {
              name: "@rollercoaster-dev/openbadges-core",
              message:
                "UI package: must not import core. See docs/architecture/overview.md",
            },
          ],
        },
      ],
  ...
  {
    files: [
      "packages/rd-logger/**/transports/**/*.ts",
      "packages/rd-logger/**/adapters/**/*.ts",
    ],
    rules: {
      "no-console": "off",
    },
