...
- [ ] `architecture/data-model.md` — Define Goals, Plans, Steps, Badges, SkillTree entities and their relationships. Maps learning graph + planning graph concepts to a mobile data model
