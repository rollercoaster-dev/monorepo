...
try {
  ...
  const latestVersion = execSync("npm view pnpm version", {
    encoding: "utf-8",
  }).trim();
  ...
  const currentVersion =
    packageJson.packageManager?.replace("pnpm@", "") || "unknown";
  ...
  console.log(
    `   3. Commit: git commit -am "chore: update pnpm to ${latestVersion}"\n`,
  );
} catch (error) {
