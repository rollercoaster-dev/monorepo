...
describe("Cryptographic Utilities", () => {
  ...
  describe("Data Signing and Verification", () => {
    ...
    it("should reject invalid signatures", () => {
      ...
      const isValidWrongData = verifySignature(
        "wrong data",
        signature,
        keyPair.publicKey,
        KeyType.RSA,
      ...
      const isValidWrongSignature = verifySignature(
        data,
        "wrong signature",
        keyPair.publicKey,
        KeyType.RSA,
      ...
      const isValidWrongKey = verifySignature(
        data,
        signature,
  ...
  describe("Assertion Verification", () => {
    it("should create a verification object with the correct structure", () => {
      ...
      expect(verification.verificationMethod).toMatch(
        /^https?:\/\/[^/]+\/public-keys\/default$/,
      );
    ...
    it("should reject invalid assertion verifications", () => {
      ...
      const isValidWrongId = verifyAssertion(
        "wrong-id",
        verification,
        keyPair.publicKey,
      );
      ...
      const isValidNoVerification = verifyAssertion(
        assertionId,
        null,
        keyPair.publicKey,
      );
      ...
      const isValidNoSignature = verifyAssertion(
        assertionId,
        { ...verification, proofValue: null },
        keyPair.publicKey,
      );
      ...
      // Verify with wrong public key
      const isValidWrongKey = verifyAssertion(
        assertionId,
        verification,
        otherKeyPair.publicKey,
      );
