...
| **1. OB 2.0 feature‑complete**          | Offer every optional OB 2.0 capability          | - _Signed Assertions_:<br>&nbsp;&nbsp;&bull; Generate JWS (RS256) for each assertion<br>&nbsp;&nbsp;&bull; Expose issuer publicKey in profile                                                                              | Upgrade to full Open Badges 2.0 and 3.0 compliance                                   |
