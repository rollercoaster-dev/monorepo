...
describe('DID Utilities', () => {
  describe('generateDidWeb', () => {
    ...
    it('should generate did:web from URL with path', () => {
      expect(generateDidWeb('https://example.com/issuers/123')).toBe(
        'did:web:example.com:issuers:123'
      );
    });

    it('should handle URL with port number', () => {
      expect(generateDidWeb('https://example.com:8080')).toBe(
  ...
  describe('isValidDidWeb', () => {
    it('should return true for valid did:web', () => {
      ...
      expect(isValidDidWeb('did:web:example.com:issuers:123')).toBe(true);
    });
  ...
  describe('didWebToUrl', () => {
    it('should convert did:web to URL', () => {
      ...
      expect(didWebToUrl('did:web:example.com:issuers:123')).toBe(
        'https://example.com/issuers/123'
      );
    });
