...
describe('IconPicker', () => {
  ...
  describe('trigger button', () => {
    it('renders with current icon name in accessibility label', () => {
      ...
      const trigger = screen.getByLabelText('Selected icon: Trophy. Tap to change');
    ...
    it('shows the icon label as display text', () => {
      renderWithProviders(<IconPicker {...defaultProps} selectedIcon="Crown" />);
  ...
  describe('modal', () => {
    ...
    it('renders preview bar with selected icon info', () => {
      ...
      expect(screen.getByLabelText('Selected: Trophy, Regular')).toBeOnTheScreen();
    });
