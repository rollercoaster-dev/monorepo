...
describe('CenterLabel', () => {
  ...
  it('scales font size with scale prop', () => {
    const el = CenterLabel({ label: 'Test', size: 256, fillColor: DARK_FILL, scale: 0.72 });
    expect(el!.props.fontSize).toBeCloseTo(256 * CENTER_LABEL_SIZE_RATIO * 0.72, 5);
  });

  it('adjusts y position when scale changes', () => {
    const defaultEl = CenterLabel({ label: 'Test', size: 256, fillColor: DARK_FILL });
    const scaledEl = CenterLabel({ label: 'Test', size: 256, fillColor: DARK_FILL, scale: 0.72 });
  ...
  it('accepts custom fontFamily', () => {
    const el = CenterLabel({ label: 'Test', size: 256, fillColor: DARK_FILL, fontFamily: 'Lexend' });
  ...
  it('clamps label to 10 characters', () => {
    const el = CenterLabel({ label: 'This is too long', size: 256, fillColor: DARK_FILL });
