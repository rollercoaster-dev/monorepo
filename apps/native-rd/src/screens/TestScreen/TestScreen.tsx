  ...
  return (
    <View style={styles.previewSection}>
      ...
      <View style={styles.previewGrid}>
        <View style={styles.narrativeCard(theme.narrative.climb.bg, theme.narrative.climb.text, theme)}>
          <Text style={styles.badgeLabel(theme.narrative.climb.text, theme.narrative.climb.bg, theme)}>
            Climb
          </Text>
          <Text style={styles.previewBody(theme)}>{copy.climb}</Text>
        </View>
        <View style={styles.narrativeCard(theme.narrative.drop.bg, theme.narrative.drop.text, theme)}>
          <Text style={styles.badgeLabel(theme.narrative.drop.text, theme.narrative.drop.bg, theme)}>
            Drop
          </Text>
          <Text style={styles.previewBody(theme)}>{copy.drop}</Text>
        </View>
        <View style={styles.narrativeCard(theme.narrative.stories.bg, theme.narrative.stories.text, theme)}>
          {storyLabels ? (
            <View style={styles.storyLabelRow}>
              {storyLabels.map((item) => (
                <Text
                  key={item.label}
                  style={styles.storyLabel(item.color, theme.narrative.stories.accentForeground, theme)}
                >
                  {item.label}
                </Text>
              ))}
            ...
            <Text
              style={styles.badgeLabel(theme.narrative.stories.accentForeground, theme.narrative.stories.accent1, theme)}
            >
              Stories
            </Text>
          )}
        ...
        <View style={styles.narrativeCard(theme.narrative.relief.bg, theme.narrative.relief.text, theme)}>
          <Text style={styles.badgeLabel(reliefLabelText, theme.narrative.relief.accent, theme)}>
            Relief
          </Text>
...
function renderAccentPalette(theme: ComposedTheme, desc: string, accents: AccentLabel[]) {
  return (
    <View style={styles.previewSection}>
      ...
      <View style={styles.accentPaletteRow(accents.length)}>
        {accents.map((accent) => (
          <View key={accent.label} style={styles.accentSwatch(accent.color, theme)}>
            <Text style={styles.accentText(theme.narrative.stories.accentForeground, theme)}>
              {accent.label}
            </Text>
          </View>
        ))}
...
function renderLanding(theme: ComposedTheme) {
  return (
    <View style={styles.previewSection}>
      <Text style={styles.previewSectionTitle(theme)}>The Full Ride (Landing)</Text>
      <Text style={styles.previewSectionDesc(theme)}>
        Full narrative arc showcase: Climb, Drop, Stories, Relief.
      </Text>
      <View style={styles.landingBlock(theme.narrative.climb.bg, theme.narrative.climb.text, theme)}>
        <Text style={styles.displayText(theme, '7xl')}>Badges{'\n'}with bite.</Text>
        ...
        <View style={styles.landingCtaRow}>
          ...
          <Text style={styles.badgeLabel(theme.narrative.climb.bg, theme.narrative.climb.text, theme)}>
            Watch demo
          </Text>
        </View>
      </View>

      <View style={styles.landingBlock(theme.narrative.drop.bg, theme.narrative.drop.text, theme)}>
        <Text style={styles.displayText(theme, '6xl', theme.narrative.drop.accent)}>
          Make it{'\n'}official.
        </Text>
        <Text style={styles.previewBody(theme)}>
        ...
        <View style={styles.landingCtaRow}>
          ...
          <Text style={styles.badgeLabel(theme.narrative.drop.bg, theme.narrative.drop.accent, theme)}>
            Local-first
          </Text>
        </View>
      </View>

      <View style={styles.landingBlock(theme.narrative.stories.bg, theme.narrative.stories.text, theme)}>
        <Text style={styles.displayText(theme, '5xl')}>Every badge{'\n'}tells a story.</Text>
        <View style={styles.storyLabelRow}>
          {[
      ...
      <View style={styles.landingBlock(theme.narrative.relief.bg, theme.narrative.relief.text, theme)}>
        <Text style={styles.displayText(theme, '5xl')}>Start{'\n'}building.</Text>
        <Text style={styles.previewBody(theme)}>
          Open source. Accessible by default. Ready when you are.
        </Text>
        <View style={styles.landingCtaRow}>
          <Text style={styles.badgeLabel(pickReadableText(theme.narrative.relief.accent), theme.narrative.relief.accent, theme)}>
            View on GitHub
          </Text>
        </View>
      </View>
  ...
  const previewThemes: ThemePage[] = [
    {
      ...
      kind: 'standard',
      theme: defaultTheme,
      narrativeDesc: 'The four narrative sections as they render in the default mood.',
      narrativeCopy: {
    ...
    },
    {
      ...
      kind: 'standard',
      theme: darkTheme,
      narrativeDesc: 'The four narrative sections adapted for the Night Ride mood.',
      narrativeCopy: {
        climb: 'Energy builds. Yellow warmth.',
    ...
    },
    {
      ...
      narrativeDesc: 'The four narrative sections adapted for the Bold Ink mood.',
      narrativeCopy: {
      ...
      storyLabels: [
        { label: 'Bright Teal', color: highContrastTheme.narrative.stories.accent1 },
        { label: 'Bright Orange', color: highContrastTheme.narrative.stories.accent2 },
        { label: 'Bright Purple', color: highContrastTheme.narrative.stories.accent3 },
        { label: 'Bright Blue', color: highContrastTheme.narrative.stories.accent4 },
      ],
      accentPalette: [
        { label: 'Bright Teal', color: highContrastTheme.narrative.stories.accent1 },
        { label: 'Bright Orange', color: highContrastTheme.narrative.stories.accent2 },
    ...
    },
    {
      ...
      kind: 'standard',
      theme: dyslexiaTheme,
      narrativeDesc: 'The four narrative sections adapted for the Warm Studio mood.',
      narrativeCopy: {
    ...
    },
    {
      ...
      kind: 'standard',
      theme: autismTheme,
      narrativeDesc: 'The four narrative sections adapted for the Still Water mood.',
      narrativeCopy: {
    ...
    },
    {
      ...
      narrativeDesc: 'The four narrative sections adapted for the Loud & Clear mood.',
      narrativeCopy: {
      ...
      storyLabels: [
        { label: 'Strong Teal', color: lowVisionTheme.narrative.stories.accent1 },
        { label: 'Strong Orange', color: lowVisionTheme.narrative.stories.accent2 },
        { label: 'Strong Purple', color: lowVisionTheme.narrative.stories.accent3 },
        { label: 'Strong Blue', color: lowVisionTheme.narrative.stories.accent4 },
      ],
      accentPalette: [
        { label: 'Strong Teal', color: lowVisionTheme.narrative.stories.accent1 },
        { label: 'Strong Orange', color: lowVisionTheme.narrative.stories.accent2 },
      ...
      typeSampleBody: 'Atkinson Hyperlegible body copy, designed for legibility.',
      typeSampleMono: 'DM Mono metadata sample.',
    },
    {
      id: 'low-info',
      ...
      kind: 'standard',
      theme: lowInfoTheme,
      narrativeDesc: 'The four narrative sections adapted for the Clean Signal mood.',
      narrativeCopy: {
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.stack}>
            <View style={styles.overviewBlock(theme.narrative.climb.bg, theme.narrative.climb.text, theme)}>
              <Text style={styles.badgeLabel(theme.narrative.climb.text, theme.narrative.climb.bg, theme)}>Climb</Text>
            ...
            <View style={styles.overviewBlock(theme.narrative.drop.bg, theme.narrative.drop.text, theme)}>
              <Text style={styles.badgeLabel(theme.narrative.drop.text, theme.narrative.drop.bg, theme)}>Drop</Text>
            ...
            <View style={styles.overviewBlock(theme.narrative.stories.bg, theme.narrative.stories.text, theme)}>
              <Text style={styles.badgeLabel(theme.narrative.stories.accentForeground, theme.narrative.stories.accent1, theme)}>
                Stories
              </Text>
              <Text style={styles.narrativeTitle(theme)}>The Stories</Text>
              <Text style={styles.previewBody(theme)}>
                Deep indigo canvas. Multi-color accents for individual badge stories.
              </Text>
              <Text style={styles.overviewCode(theme)}>
                --ob-narrative-stories-bg / --ob-narrative-stories-text
              </Text>
            </View>
            <View style={styles.overviewBlock(theme.narrative.relief.bg, theme.narrative.relief.text, theme)}>
              <Text style={styles.badgeLabel(pickReadableText(theme.narrative.relief.accent), theme.narrative.relief.accent, theme)}>
                Relief
              </Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.displayBlock(theme)}>
            <Text style={styles.displayText(theme, '5xl')}>Badges{'\n'}with bite.</Text>
          </View>
          <View style={styles.row}>
            <View style={styles.sectionBlock(theme)}>
              <Text style={styles.badgeLabel(theme.colors.backgroundSecondary, theme.colors.text, theme)}>
                Section Block
              </Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.typeSamples(theme)}>
            ...
            <Text style={styles.previewMono(theme)}>DM Mono for code and metadata.</Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionDesc}>
            Each mood adapts the narrative arc for different accessibility needs.
          </Text>
          <View style={styles.row}>
            {[
        ...
        <View style={styles.section}>
          ...
          {previewThemes.map((page) => (
            <View key={page.id} style={styles.previewCard(page.theme)}>
              ...
              <Text style={styles.previewSubtitle(page.theme)}>{page.subtitle}</Text>
              ...
              {page.accentPalette
                ...
                : null}
              {renderTypeSamples(page.theme, page.typeSampleBody, page.typeSampleMono)}
            </View>
          ))}
        </View>
      </ScrollView>
