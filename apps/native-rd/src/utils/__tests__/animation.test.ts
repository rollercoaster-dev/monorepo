...
describe("animation utilities", () => {
  ...
  test("reduced durations are shorter than full", () => {
    expect(ANIMATION_DURATIONS.reduced.quick).toBeLessThan(
      ANIMATION_DURATIONS.full.quick,
    );
    expect(ANIMATION_DURATIONS.reduced.normal).toBeLessThan(
      ANIMATION_DURATIONS.full.normal,
    );
    expect(ANIMATION_DURATIONS.reduced.slow).toBeLessThan(
      ANIMATION_DURATIONS.full.slow,
    );
  });
