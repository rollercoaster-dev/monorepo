...
function reorder(steps: Step[], draggedIndex: number, hoverIndex: number): string[] {
...
function calcHoverIndex(draggedIndex: number, translationY: number, itemHeight: number, total: number): number {
