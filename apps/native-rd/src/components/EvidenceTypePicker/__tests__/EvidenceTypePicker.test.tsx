...
describe('EvidenceTypePicker', () => {
  ...
  describe('full mode', () => {
    ...
    it('marks selected types with checked state', () => {
      renderWithProviders(
        <EvidenceTypePicker
          selectedTypes={[EvidenceType.text as EvidenceTypeValue, EvidenceType.photo as EvidenceTypeValue]}
          onToggleType={jest.fn()}
        />,
      );
    ...
    it.each([
      ['selected', [EvidenceType.photo as EvidenceTypeValue], 'Take Photo', 'Deselect Take Photo'],
      ['unselected', [], 'Take Photo', 'Select Take Photo'],
    ])('shows correct hint for %s chip', (_label, types, chipLabel, expectedHint) => {
      renderWithProviders(
        <EvidenceTypePicker
          selectedTypes={types}
          onToggleType={jest.fn()}
  ...
  describe('compact mode', () => {
    it('renders only selected types', () => {
      renderWithProviders(
        <EvidenceTypePicker
          selectedTypes={[EvidenceType.photo as EvidenceTypeValue, EvidenceType.voice_memo as EvidenceTypeValue]}
          onToggleType={jest.fn()}
          compact
        />,
      );
