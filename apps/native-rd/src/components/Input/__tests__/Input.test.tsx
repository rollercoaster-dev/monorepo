...
describe('Input', () => {
  ...
  it('calls onChangeText when user types', () => {
    ...
    renderWithProviders(<Input placeholder="Type here" onChangeText={onChangeText} />);
  ...
  it('sets accessibilityState.disabled=true when editable=false', () => {
    ...
    expect(screen.getByPlaceholderText('Read only')).toHaveProp('accessibilityState', {
      disabled: true,
    });
  });
  ...
  it('sets accessibilityState.disabled=false when editable is not set', () => {
    ...
    expect(screen.getByPlaceholderText('Normal')).toHaveProp('accessibilityState', {
      disabled: false,
    });
  });
});
