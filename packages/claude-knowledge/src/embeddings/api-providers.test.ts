...
import { OpenAIEmbedding, createEmbeddingProvider } from "./api-providers";
...
describe("createEmbeddingProvider", () => {
  ...
  test("throws error for Anthropic (not available)", async () => {
    await expect(
      createEmbeddingProvider("anthropic", { apiKey: "test" }),
    ).rejects.toThrow("not yet publicly available");
  });
