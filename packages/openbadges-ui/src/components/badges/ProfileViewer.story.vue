  ...
  >
    <template #docs>
      <div class="histoire-docs">
        <h1>ProfileViewer</h1>
        <p>
          The <code>ProfileViewer</code> component displays a user or issuer
          profile along with their badges. It supports grid and list layouts,
          pagination, and interactive badge actions. The component is designed
          with accessibility and theme customization in mind.
        </p>
        <h2>When To Use</h2>
        <ul>
          <li>
            To display a profile (recipient or issuer) with associated badges
          </li>
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>Required</td>
              <td>The profile data (recipient or issuer)</td>
            </tr>
            <tr>
            ...
            <tr>
              <td><code>badges-layout</code></td>
              <td><code>'grid' | 'list'</code></td>
              <td><code>'grid'</code></td>
              <td>Layout for badges</td>
            </tr>
            <tr>
              <td><code>badges-interactive</code></td>
              <td><code>boolean</code></td>
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>Custom content for the profile header</td>
            </tr>
            <tr>
              <td><code>badge</code></td>
              <td>Custom rendering for each badge</td>
            </tr>
          </tbody>
        </table>
        <h2>Accessibility</h2>
