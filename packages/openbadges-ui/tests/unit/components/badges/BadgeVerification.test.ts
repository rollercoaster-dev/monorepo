...
describe("BadgeVerification.vue", () => {
  ...
  it("renders verification status correctly", async () => {
    ...
    expect(wrapper.find("button.ob-badge-verification-button").text()).toBe(
      "Verify Badge",
    );
    ...
    expect(wrapper.find(".ob-badge-verification-valid").text()).toContain(
      "Verified",
    );
    expect(wrapper.find(".ob-badge-verification-button").text()).toBe(
      "Verify Again",
    );
  });
  ...
  it("displays verification details when showDetails is true", async () => {
    ...
    expect(wrapper.find(".ob-badge-verification-method").text()).toContain(
      "Hosted",
    );
    expect(wrapper.find(".ob-badge-verification-expiration").exists()).toBe(
      true,
    );
    expect(wrapper.find(".ob-badge-verification-revocation").exists()).toBe(
      true,
    );
  });
  ...
  it("respects showLastVerified prop", async () => {
    ...
    expect(wrapper.find(".ob-badge-verification-timestamp").exists()).toBe(
      false,
    );
  });
});
