...
function convertOB2toOB3Example() {
  ...
  console.log(
    "Converted OB3 VerifiableCredential:",
    JSON.stringify(ob3Credential, null, 2),
  );
...
function convertOB3toOB2Example() {
  ...
  console.log(
    "Original OB3 VerifiableCredential:",
    JSON.stringify(ob3Credential, null, 2),
  );
  console.log(
    "Converted OB2 Assertion:",
    JSON.stringify(ob2Assertion, null, 2),
  );
  ...
  const issuer =
    typeof badgeClass.issuer === "string"
      ...
      : {
          ...
          url:
            typeof badgeClass.issuer === "object" && "url" in badgeClass.issuer
              ? createIRI(badgeClass.issuer.url as string)
              : undefined,
          email:
            typeof badgeClass.issuer === "object" &&
            "email" in badgeClass.issuer
              ? (badgeClass.issuer.email as string)
              : undefined,
        };
  ...
  const badgeClass: OB2.BadgeClass = {
    ...
    image: achievement.image
      ? typeof achievement.image === "string"
        ? createIRI(achievement.image)
        : achievement.image
      : createIRI("https://example.org/placeholder-image"),
    ...
    issuer:
      typeof credential.issuer === "string"
        ...
        : {
            ...
            type: "Profile",
            name:
              typeof credential.issuer.name === "string"
  ...
  if (credential.evidence) {
    ...
    if (credential.evidence) {
      if (Array.isArray(credential.evidence)) {
        assertion.evidence =
          credential.evidence[0].id ||
          createIRI("https://example.org/evidence/default");
      } else {
        assertion.evidence =
...
function versionDetectionExample() {
  ...
  function processAnyBadge(
    badgeData: unknown,
    targetVersion: OpenBadgesVersion,
  ): unknown {
  ...
  console.log(
    "Result type:",
    OB3.isVerifiableCredential(ob2ToOb3)
  ...
  console.log(
    "Result type:",
    OB2.isAssertion(ob3ToOb2) ? "OB2 Assertion" : "Unknown",
  );
  ...
  console.log(
    "Result type:",
    OB2.isAssertion(ob2ToOb2) ? "OB2 Assertion" : "Unknown",
  );
  ...
  console.log(
    "Result type:",
    OB3.isVerifiableCredential(ob3ToOb3)
      ? "OB3 VerifiableCredential"
      : "Unknown",
  );
}
