 ...
 */
export function getBadgeRecipient(
  badge: Badge,
): OB2.IdentityObject | OB3.CredentialSubject | null {
  if (OB2.isAssertion(badge)) {
...
export function getBadgeCriteria(
  badge: Badge,
): OB2.Criteria | OB3.Criteria | null {
  if (OB2.isAssertion(badge)) {
    const badgeClass = getBadgeClass(badge);
    if (!badgeClass) return null;
 ...
 */
export function getBadgeEvidence(
  badge: Badge,
): OB2.Evidence | OB3.Evidence | null {
  if (OB2.isAssertion(badge)) {
