...
// OB2 Helpers
export const createOB2Assertion = (
...
// OB3 Helpers
export const createOB3Achievement = (
  overrides?: Partial<OB3.Achievement>,
): OB3.Achievement => {
  return {
...
export const createOB3Issuer = (
  overrides?: Partial<OB3.Issuer>,
): OB3.Issuer => {
  return {
    "@context": "https://purl.imsglobal.org/spec/ob/v3p0/context.json",
...
export const validOB2BadgeClass: OB2.BadgeClass =
  validOB2Assertion.badge as OB2.BadgeClass;
...
export const validOB2Profile: OB2.Profile =
  validOB2BadgeClass.issuer as OB2.Profile;
...
export const validOB2IdentityObject: OB2.IdentityObject =
  validOB2Assertion.recipient;
...
export const validOB2VerificationObject: OB2.VerificationObject =
  validOB2Assertion.verification;
