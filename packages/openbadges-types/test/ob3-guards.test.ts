...
describe("OB3 Type Guards", () => {
  ...
  describe("isCredentialSubject", () => {
    test("should correctly identify valid OB3 CredentialSubject objects", () => {
      const validCredentialSubject =
        createOB3VerifiableCredential().credentialSubject;
  ...
  describe("isProof", () => {
    test("should correctly identify valid OB3 Proof objects", () => {
      const validProof: OB3.Proof = {
        ...
        verificationMethod: Shared.createIRI(
          "https://example.org/issuers/123#keys-1",
        ),
  ...
  describe("isCriteria", () => {
    ...
    test("should accept objects with narrative property", () => {
      expect(
        OB3.isCriteria({ narrative: "Must complete all assignments" }),
      ).toBe(true);
    });
