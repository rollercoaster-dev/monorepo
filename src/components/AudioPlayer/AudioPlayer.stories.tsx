...
export const Default: Story = {
  render: () => (
    <View style={storyStyles.container}>
      <Text variant="label" style={storyStyles.label}>Audio Player — initial state</Text>
...
export const WithKnownDuration: Story = {
  render: () => (
    <View style={storyStyles.container}>
      <Text variant="label" style={storyStyles.label}>With known duration (2m 30s)</Text>
...
export const ShortClip: Story = {
  render: () => (
    <View style={storyStyles.container}>
      <Text variant="label" style={storyStyles.label}>Short clip (15s)</Text>
