...
type SvgPathProps = { stroke: string; strokeWidth: number; fill: string; d: string; children?: React.ReactNode };
...
describe('frameRegistry', () => {
  ...
  test.each(['none', 'guilloche', 'crossHatch', 'microprint', 'rosette'] as const)(
    '%s returns null',
    (frame) => {
