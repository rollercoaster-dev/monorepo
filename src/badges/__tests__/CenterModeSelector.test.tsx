...
describe('CenterModeSelector', () => {
  ...
  it('marks icon as checked when icon mode selected', () => {
    ...
    expect(screen.getByLabelText('Icon center').props.accessibilityState).toEqual(
      expect.objectContaining({ checked: true }),
    );
    expect(screen.getByLabelText('Monogram center').props.accessibilityState).toEqual(
  ...
  it('marks monogram as checked when monogram mode selected', () => {
    renderWithProviders(
      <CenterModeSelector {...defaultProps} selectedMode={BadgeCenterMode.monogram} />,
    );
