...
const mockCreateEvidence = createEvidence as jest.MockedFunction<typeof createEvidence>;
...
describe('CaptureLinkScreen', () => {
  ...
  it('shows link preview when a valid URL is entered', () => {
    ...
    expect(screen.getByLabelText('Link preview: https://example.com/path')).toBeTruthy();
  });
